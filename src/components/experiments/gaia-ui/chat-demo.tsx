// astro-doctor-ignore-file astro/no-huge-file -- experiment demo bundle (data + variants kept together deliberately)
"use client";
...
const DEFAULT_AVATAR = "/images/site/avatar.webp";
