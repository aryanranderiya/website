  ...
  if (logo && !imgError) {
    return (
      <img
        ...
        className={logoInvert ? 'invert dark:invert-0' : undefined}
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        >
          <span
            className="text-[13px] font-semibold text-[var(--text-secondary)] tracking-[-0.01em] transition-colors duration-150"
        ...
        {compact && (
          <div className="text-[12px] text-[var(--text-ghost)] mb-0 mt-[1px]">
            {exp.role}
          </div>
        )}
        ...
        {!compact && (
          <div
            className={[
              ...
              exp.description || exp.highlights.length > 0 || exp.skills.length > 0 ? 'mb-2' : 'mb-0',
            ].join(' ')}
          >
