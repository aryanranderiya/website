    ...
    <div className="bg-[#0d1117] border border-[#30363d] rounded-xl p-4 w-[420px] shadow-2xl overflow-hidden font-sans text-[#e6edf3]">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="min-w-0">
          <div className="font-semibold text-sm text-[#e6edf3] leading-tight">
            Aryan
          </div>
          <div className="text-xs text-[#8b949e] leading-tight">
            @aryanranderiya
          </div>
        </div>
      </div>
      ...
      <p className="text-xs text-[#8b949e] leading-relaxed mb-2">
        founder &amp; ceo{" "}
        <span className="text-[#58a6ff]">@theexperiencecompany</span>
      </p>
  ...
  return (
    <div className="bg-black border border-[#2f3336] rounded-xl overflow-hidden w-[280px] shadow-2xl font-sans text-[#e7e9ea]">
      ...
      <div className="px-4 pb-4 relative">
        ...
        />
        <div className="pt-7">
          <div className="font-bold text-[15px] text-[#e7e9ea] leading-tight">
            aryan
          </div>
          <div className="text-xs text-[#71767b] mb-2">
            @aryanranderiya · 13.8K posts
          </div>
          <p className="text-[13px] text-[#e7e9ea] leading-relaxed mb-3">
            founder &amp; ceo <span className="text-[#1d9bf0]">@madebyexp</span>
            . building <span className="text-[#1d9bf0]">@trygaia</span>
          </p>
  ...
  return (
    <div className="bg-[#1b1f23] border border-[#283339] rounded-xl overflow-hidden w-[260px] shadow-xl font-sans text-[#e7e9ea]">
      ...
      <div className="px-4 pb-4 relative">
        ...
        />
        <div className="pt-8">
          <div className="font-bold text-sm text-[#e7e9ea] mb-0.5">
            Aryan Randeriya
          </div>
      ...
      <div className="border-t border-[#283339] px-4 py-2.5 bg-[rgba(0,119,181,0.08)]">
        <span className="text-xs text-[#0077b5] font-semibold">
          View full profile
        </span>
      </div>
    </div>
  ...
  return (
    <div className="bg-black border border-[#262626] rounded-xl p-4 w-[260px] shadow-2xl font-sans text-[#f5f5f5]">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="min-w-0">
          <div className="font-semibold text-sm text-[#f5f5f5] leading-tight">
            aryanranderiya
          </div>
          <div className="text-xs text-[#a8a8a8] leading-tight">A'</div>
        </div>
      </div>
      <p className="text-xs text-[#f5f5f5] leading-relaxed mb-3">
        the world is yours
      </p>
  ...
  return (
    <>
      ...
      >
        ...
        >
          <span className={`flex items-center transition-opacity duration-150 ${hovered ? "opacity-100" : "opacity-65"}`}>
            {social.icon}
          </span>
          {social.label}
        </a>
