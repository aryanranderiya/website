/**
 * VinylDisk vendored from Bun UI (https://www.bunui.xyz/components/vinyl-player,
 * MIT-style free use, attribution appreciated). Only formatting/imports adapted;
 * the SVG artwork is verbatim. The full-card VinylPlayer was dropped — the disk
 * is integrated into the homepage Spotify widget instead.
 */
"use client";
