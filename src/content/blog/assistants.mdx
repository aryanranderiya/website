...
hi so i'm the founder of [the experience company](https://experience.heygaia.io) and we're building a personal assistant called [gaia](https://heygaia.io).

i've been working on this for some time now when it started out as a project in college which i eventually ended up wanting to turn into a startup.

my belief system started with the vision that i wanted to build an assistant that everyone in the world could use. 
...
## a lot of people are building assistants
...
<Tweet id="2099577663740613107" />

## why this is so hard

there's a ton of issues and unanswered questions yet to figure out in this space that are just non-trivial.

i feel like building a company like this isn't as simple as a very specific hyper niche use-case like "building ai for lawyers" (a crude example perhaps), that's why it's even harder to get it right.

it's fundamentally just a broad idea with a large array of problems to solve that need to be gotten right for the first time.
...
2 things. retention, and market. 

**1. retention**
<br/>this is notoriously one of the hardest things to figure out for any consumer software product. even more so with ai agents considering this is just a completely new surface area of how products work and how most consumers interact with such technology.

**2. market**
<br/>the market is just extremely early while the technology is way too ahead. eventually the market will catch up tho. we are too early for our time and so are most companies in this space imo. if someone says meta has all the distribution to market an ai assistant i just disagree. they had all the distribution for the vr space too, what happened there? they were too early. nobody was ready yet for it. nobody understood it yet. the same applies for ai. 

<figure>
  <img src="/images/blog/assistants/AI_Usage_Chart.png" alt="Theoretical capabaility and observed usage by occupational category by Anthropic." />
  <figcaption>
  <a href="https://www.anthropic.com/research/labor-market-impacts">Labor market impacts of AI: A new measure and early evidence</a>
</figcaption>
</figure>


it's not just about industries either, like software development is the most popular industry where ai is used. but in the average world outside of twitter or outside sf or the valley, people still don't use ai the way the top 1% do. hell i barely even saw people using claude code. the company i used to work at was fairly ai forward but shared a single max plan between like 20 people and my co-founder's and my individual usage was more than the rest of the entire company's usage combined. i've seen people still using and advocating for github copilot or copy-pasting code or being LLM averse when the frontier is light years ahead. it's apparent that the distance between the top 1% and the rest will take a long time to bridge the gap just because it's just progressing too fast for most to keep playing catch up.
...
<figure>
  <img src="/images/blog/assistants/opencode1.png" alt="Theoretical capabaility and observed usage by occupational category by Anthropic." />
  <figcaption>
  <a href="https://opencode.ai/data">OpenCode Model Data</a>
</figcaption>
</figure>
...
btw i'm going to be moving to sf soon. so if you're reading this and wanna meet up and have a chat feel free to get in touch with me.

also, go sign up: [heygaia.io](https://heygaia.io) and [email me](mailto:aryan@heygaia.io) if you have feedback!
